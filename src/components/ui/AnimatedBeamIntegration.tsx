...
export function AnimatedBeamIntegration({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-full w-full items-center justify-center overflow-hidden p-4",
        className
      )}
      ref={containerRef}
    >
      <div className="flex h-full w-full max-h-full max-w-full flex-col items-stretch justify-between gap-4">
